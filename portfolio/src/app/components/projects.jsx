...
export default function Projects(){
    return (
        ...
        <main className="flex flex-col justify-center items-center">
            <h1 className="text-2xl font-medium capitalize my-10"> My journey</h1>
  ...
  <li>
    ...
    <div className="timeline-start md:text-end mb-10">
      <time className="font-mono italic">22 July 2023</time>
      <div className="text-lg font-black">being accepted into Re:coded bootcamp</div>
